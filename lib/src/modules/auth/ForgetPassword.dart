...
class _ForgetPasswordState extends State<ForgetPassword> {
  ...
  Future<void> forgetPassword() async {
    if (number == null || number!.trim().isEmpty) {
      ToastMsg().sendErrorMsg("Phone number is required");
      return;
    } else {
      try {
        setState(() {
        ...
        bool? result = await ApiService().sendMobileOtp(mobileNumber: number!);
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Text(
                      "Let's Recover Your Password".toUpperCase(),
                    ...
                    Padding(
                      ...
                      child: RichText(
                        ...
                        text: TextSpan(children: <TextSpan>[
                          TextSpan(
                              text: 'As you Sign In, you accept our ',
                              style: TextStyles.bodyBlack,
